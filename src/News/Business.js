...
class BusinessNews extends React.Component{
    ...
    state={news:[]};
    componentWillMount(){
        axios.get('https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=5ca0ef6e66a54e0c908b4d4c45baedb1')
    ...
    renderdata(){
        return this.state.news.map(singlenews=>
             <BusinessDetails key={singlenews.url}  singlenews={singlenews} />
           );
     }
    render(){
        return(
