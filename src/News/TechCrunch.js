...
import TechCrunchDetail from './TechCrunchDetails';
...
class TechCrunch extends React.Component{
    ...
    state={news:[]};
    componentWillMount(){
        axios.get('https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=5ca0ef6e66a54e0c908b4d4c45baedb1')
    ...
    renderdata(){
        return this.state.news.map(singlenews=>
             <TechCrunchDetail key={singlenews.url} image={singlenews.urlToImage} singlenews={singlenews} />
           );
     }
    render(){
        return(
